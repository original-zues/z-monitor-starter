...
public class ZMonitorAutoConfiguration {
    ...
    public ZMonitorMetricsProvider zMonitorMetricsProvider(io.micrometer.core.instrument.MeterRegistry meterRegistry) {
        return new ZMonitorDefaultMetricsProvider(meterRegistry);
    }
